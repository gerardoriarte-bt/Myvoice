...
| H2.E | **La segunda ronda: el cliente aprueba la pieza** · DISEÑADA, lista para construir | Hoy el cliente aprueba un texto y **nunca ve el arte final**: `ReviewSessionItem` apunta solo a `SavedVariation`. Se agrega una segunda ronda sobre la pieza terminada —después del visto bueno interno, opcional por campaña— con el feedback desglosado en copy y diseño. Ese desglose es el enrutador: lo de diseño va al diseñador, lo de copy vuelve al motor **como propuesta**, porque una clasificación equivocada le enseña basura a la IA. No reemplaza la ronda 1: mover la aprobación al final pondría la decisión del cliente después del gasto de diseño. [plan](./plan-h2e-aprobacion-de-pieza.md) |
...
| H3.D | **Funciones del equipo y notificaciones** · DISEÑADA, lista para construir | Quién escribe, quién diseña y quién aprueba —un eje aparte del permiso, que sugiere y no restringe— y que a cada uno le llegue lo que le toca. Dos eventos y nada más: asignación y entrega. De paso arregla que hoy la única notificación que existe **va a una casilla fija del entorno**, no a la persona. [plan](./plan-h3d-funciones-notificaciones.md) |
