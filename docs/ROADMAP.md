...
| H2.E | **La segunda ronda: el cliente aprueba la pieza** · DISEÑADA, falta nivel 2 | Hoy el cliente aprueba un texto y **nunca ve el arte final**: `ReviewSessionItem` apunta solo a `SavedVariation`. Se agrega una segunda ronda sobre la pieza terminada —después del visto bueno interno, opcional por campaña— con el feedback desglosado en copy y diseño. Ese desglose es el enrutador: lo de diseño va al diseñador, lo de copy vuelve al motor **como propuesta**, porque una clasificación equivocada le enseña basura a la IA. No reemplaza la ronda 1: mover la aprobación al final pondría la decisión del cliente después del gasto de diseño. [plan](./plan-h2e-aprobacion-de-pieza.md) |
